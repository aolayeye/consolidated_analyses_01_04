...
b.	Build a multiple regression model that considers several variables, including sale date, year built, building type, gross square feet, and the number of units to identify influential factors in sale prices. This analysis will help determine the most and least valuable predictors as well as redundant variables and bargain and overpriced real estate.
...
For this analysis, the necessary data is stored locally for use within RStudio.
...
It's crucial to remember that these results are based on a single train-test split of the data. We may consider employing cross-validation to acquire a more robust comparison of the models.
